-- ============================================
-- SIMPLIFIED DEPLOYMENT FOR SUPABASE
-- ============================================
...
INSERT INTO users (id, name, email, password, role, dealership_id, jwt_sub) VALUES
  ('user-a-000000-0000-0000-0000-000000000001', 'Gerente Loja A', 'gerente_a@loja-a.com', '$2b$10$...', 'admin', 'a0000000-0000-0000-0000-000000000001', 'gerente_a@loja-a.com'),
  ('user-b-000000-0000-0000-0000-000000000002', 'Gerente Loja B', 'gerente_b@loja-b.com', '$2b$10$...', 'admin', 'b0000000-0000-0000-0000-000000000001', 'gerente_b@loja-b.com')
ON CONFLICT DO NOTHING;
